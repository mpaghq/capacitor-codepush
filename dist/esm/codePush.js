...
class CodePush {
    ...
    syncInternal(syncCallback, syncOptions, downloadProgress) {
        ...
        const installUpdate = (localPackage) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        const downloadUpdate = (remotePackage) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        const manageUserInput = (remotePackage) => __awaiter(this, void 0, void 0, function* () {
            if (syncOptions.updateDialog) {
