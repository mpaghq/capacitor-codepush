...
1. Add your deployment & code signing (optional) keys to the `capacitor.config.json` file, making sure to include the right key:
    ...
    "Plugins": {
        ... (other plugins)
        "CodePush": {
          // "IOS_DEPLOY_KEY" is generated by App Center, look below for instructions
          "IOS_DEPLOY_KEY": "IOS_DEPLOYMENT_KEY",
          // "IOS_PUBLIC_KEY" is the content of the "public.pem" file
          "IOS_PUBLIC_KEY": "-----BEGIN PUBLIC KEY-----\n_AND_THE_REST...",
          // "ANDROID_DEPLOY_KEY" is generated by App Center, look below for instructions
          "ANDROID_DEPLOY_KEY": "ANDROID_DEPLOYMENT_KEY",
           // "ANDROID_PUBLIC_KEY" is the content of the "public.pem" file
          "ANDROID_PUBLIC_KEY": "-----BEGIN PUBLIC KEY-----\n_AND_THE_REST...",
